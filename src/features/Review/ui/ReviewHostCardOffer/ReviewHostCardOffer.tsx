...
import { GetOfferReview } from "@/entities/Review";
...
import styles from "./ReviewHostCardOffer.module.scss";

interface ReviewHostCardOfferProps {
    reviewOffer: GetOfferReview;
    locale: Locale;
}

export const ReviewHostCardOffer: FC<ReviewHostCardOfferProps> = (
    props: ReviewHostCardOfferProps,
) => {
