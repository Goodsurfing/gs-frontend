        ...
        if (teamUser) {
            ...
            return (
                <div className={styles.wrapper} onClick={() => navigateTo(profile.id)}>
                    <Avatar icon={getMediaContent(profile.image ?? undefined, "MEDIUM")} text={profile.firstName} size="MEDIUM" />
        ...
        if (profileData) {
            ...
            return (
                <div className={styles.wrapper} onClick={() => navigateTo(id)}>
                    <Avatar icon={getMediaContent(image ?? undefined, "MEDIUM")} text={firstName} size="MEDIUM" />
                    <div className={styles.userInfo}>
                        {/* <span className={styles.role}>{teamUser.role}</span> */}
                        <span className={styles.name}>
