    ...
    },
    {
        icon: (
            ...
            >
                ...
                >
                    <path d="M20 36.667c4.602 0 8.769-1.866 11.785-4.882A16.614 16.614 0 0036.667 20c0-4.602-1.866-8.77-4.882-11.785A16.614 16.614 0 0020 3.333 16.615 16.615 0 008.215 8.215 16.615 16.615 0 003.333 20c0 4.602 1.866 8.769 4.882 11.785A16.615 16.615 0 0020 36.667z"></path>
                    <path strokeLinecap="round" d="M13.333 20l5 5 10-10"></path>
                </g>
                <defs>
    ...
    },
    {
        icon: (
            ...
            >
                ...
                >
                    <path d="M33.333 18.333H6.667C5.747 18.333 5 19.08 5 20v15c0 .92.746 1.667 1.667 1.667h26.666c.92 0 1.667-.747 1.667-1.667V20c0-.92-.746-1.667-1.667-1.667z"></path>
                    <path
                        strokeLinecap="round"
    ...
    },
    {
        icon: (
            ...
            >
                ...
                >
                    <path d="M5.306 7.556l14.701-4.29 14.687 4.29v8.798a21.483 21.483 0 01-14.692 20.381A21.486 21.486 0 015.306 16.35V7.556z"></path>
                    <path
                        strokeLinecap="round"
