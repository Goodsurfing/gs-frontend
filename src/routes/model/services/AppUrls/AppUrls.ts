...
export const getOffersDescriptionPageUrl: RoutePathFunction = (locale) => `${locale}${RoutePath.offers_when}`;

export const getOffersWPageUrl: RoutePathFunction = (locale) => `${locale}${RoutePath.offers_when}`;
