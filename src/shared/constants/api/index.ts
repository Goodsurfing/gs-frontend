export const API_PUBLIC_BASE_URL = `${process.env.REACT_APP_API_BASE_URL}api/v1/public`;
export const API_ORGANIZATIONS_BASE_URL = `${process.env.REACT_APP_API_BASE_URL}api/v1/`;
