...
import { getAdminCategoriesBlogCreatePageUrl, getAdminCategoriesBlogPersonalPageUrl } from "@/shared/config/routes/AppUrls";
...
export const AdminCategoriesBlogTable = () => {
        ...
        },
        {
            ...
            renderCell: (params) => {
                const handleView = () => navigate(
                    getAdminCategoriesBlogPersonalPageUrl(locale, params.row.id),
                );
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <ButtonLink
                ...
                path={getAdminCategoriesBlogCreatePageUrl(locale)}
            >
                Добавить категорию
            </ButtonLink>
            {renderTable()}
